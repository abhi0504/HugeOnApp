        ...
        <View style={{ display: 'flex', flex: 1 }}>
            ...
            <View style={{ display: 'flex', flex: 0.9, marginLeft: 30 }}>
                <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
                    <TouchableOpacity style={{ display: 'flex', flex: 0.1, justifyContent: 'center', marginLeft: 10,  marginRight: 10  }} onPress={() => { navigation.push('DetailsScreen', "library") }}>
                        <View style={styles.container}>
                            <Svg width={30} height={30} viewBox="0 0 100 100">
                                <Circle cx={50} cy={50} r={40} fill="black" />
                            </Svg>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                    <TouchableOpacity style={{ display: 'flex', flex: 0.1, justifyContent: 'center', marginLeft: 10,  marginRight: 10  }} onPress={() => { navigation.push('DetailsScreen', "camera") }}>
                        <View style={styles.container}>
                            <Svg width={30} height={30} viewBox="0 0 100 100">
                                <Circle cx={50} cy={50} r={40} fill="black" />
                            </Svg>
